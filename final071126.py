...
# --------------------------
NIFTY_FO_TICKERS = ["^NSEI", "CL=F", "RELIANCE.NS", "TCS.NS", "HDFCBANK.NS", "INFY.NS", "ICICIBANK.NS",
    "HINDUNILVR.NS", "ITC.NS", "SBIN.NS", "BHARTIARTL.NS", "KOTAKBANK.NS",
    "LT.NS", "AXISBANK.NS", "ASIANPAINT.NS", "MARUTI.NS", "SUNPHARMA.NS",
    "TITAN.NS", "WIPRO.NS", "ULTRACEMCO.NS", "ADANIPORTS.NS", "NTPC.NS",
    "M&M.NS", "BAJFINANCE.NS", "TATAMOTORS.NS", "TATASTEEL.NS", "JSWSTEEL.NS",
    "HCLTECH.NS", "POWERGRID.NS", "NESTLEIND.NS", "HDFC.NS", "BAJAJFINSV.NS",
    ...
    "MUTHOOTFIN.NS", "PIDILITIND.NS", "DABUR.NS", "BAJAURO.NS", "INDUSINDBK.NS",
    "BSE.NS",
    "IDEA.NS",
    "POWERINDIA.NS",
    "POLYCAB.NS",
...
def render_scanner_page(page_key, fixed_interval, page_label):
    ...
    if ev_key in st.session_state:
        ...
        if events_df.empty:
            ...
            sel_label = st.selectbox("Select event", event_labels, key=f"{page_key}_event_select")
            if sel_label:
